(() => {
  ...
  var frameRate = /* @__PURE__ */ every(1e3);
  var processSignal = /* @__PURE__ */ pure(applicativeEffect)(/* @__PURE__ */ map2(function(a) {
    return "HELLO: " + show2(a);
  })(frameRate));
  var arr = /* @__PURE__ */ range2(1)(1e7);
  var main = /* @__PURE__ */ function() {
    ...
    var p2 = {
      age: 37,
      hugeData: p1.hugeData,
      name: p1.name
    };
    var p3 = {
      name: "Bob",
      age: p2.age,
      hugeData: p2.hugeData
    };
    var s1 = foldl2(add2)(0)(p1.hugeData);
    var s3 = foldl2(add2)(0)(p3.hugeData) + 1 | 0;
    return function __do() {
      log(show1(s1))();
      log(show1(s3))();
      var sig = processSignal();
      runSignal(map2(function(s) {
        return log(s);
      })(sig))();
      return log("\u{1F35D}")();
    };
