(() => {
  ...
  // output/WSviaWindowMgs/foreign.js
  ...
  // output/WSviaWindowMgs/index.js
  ...
  var renderTickAction1 = /* @__PURE__ */ renderTickAction(showString);
  var handleMessage = function(chan) {
    return function(msg) {
  ...
  var main = function __do() {
    ...
    var messageSignal = subscribe(chan);
