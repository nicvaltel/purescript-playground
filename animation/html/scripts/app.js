(() => {
    ...
    return function(n) {
      return function __do2() {
        ...
        if (v instanceof Just) {
          ...
          drawImage(ctx)(img)(toNumber(mod2(n)(1e3)))(toNumber(mod2(n)(1e3)))();
          return restore(ctx)();
        }
        ;
        throw new Error("Failed pattern match at Render (line 27, column 9 - line 27, column 53): " + [v.constructor.name]);
      };
    };
  };
  ...
  var tryLoadImageAff = function(path) {
    var wrappedFn = function(done) {
      return function __do2() {
        tryLoadImage(path)(function(maybeImage) {
          if (maybeImage instanceof Just) {
            return done(new Right(maybeImage.value0));
          }
          ;
          if (maybeImage instanceof Nothing) {
            return done(new Left(error("tryLoadImageAff Error: Could not load " + path)));
          }
          ;
          throw new Error("Failed pattern match at ResourceLoader (line 57, column 24 - line 59, column 92): " + [maybeImage.constructor.name]);
        })();
        return mempty2;
      };
    };
    return makeAff(wrappedFn);
  };

  // output/Run/index.js
  var liftEffect2 = /* @__PURE__ */ liftEffect(monadEffectAff);
  var loop = function(model) {
    return function(img) {
      return function __do2() {
  ...
  var run2 = /* @__PURE__ */ bind(bindAff)(/* @__PURE__ */ tryLoadImageAff("images/white_00.png"))(function(img) {
    return liftEffect2(loop({
      count: 0
    })(img));
  });
